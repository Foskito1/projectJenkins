...
public final class inma1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	System.out.println("CONTRATISTA " + contractor.getContractCode());
	
	listOfPriceTables = sendQueryPriceTable.sendQueryPriceTable(
                   		contractor.getContractCode());
						
	System.out.println("listado obtenido " + listOfPriceTables);
      ...
      out.write("\tdocument.formulario.action=\"cenman_price_table_importe_list.jsp?idCuadro=");
      out.print(idCuadro);
      out.write("\";\r\n");
      ...
      out.write("\t\t  <tr>\r\n");
      out.write("            <th class=\"datos2\" width=\"20%\">");
      out.print(traductor.getLiteral("Codigo"));
      out.write("</th>\r\n");
      out.write("            <th class=\"datos2\" width=\"60%\">");
	...
	if (listOfPriceTables.size()>0) {
	  ...
	  while (iterator.hasNext()){
	      ...
	      strCodCuadro="&nbsp;";
	    	...
	    	priceTable = (CenManWebContractPriceTable) iterator.next();
				loIdCuadroGen = priceTable.getIdCuadro();
      ...
      out.write("      \r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t\t<td class=\"datos5\" width=\"20%\"><a href=\"#\" onClick=\"actualizaCategorias('");
      out.print(loIdCuadroGen);
      out.write("')\" class=\"resaltar\">");
      out.print(strCodCuadro);
      out.write("</a></td>\r\n");
      out.write("\t            <td class=\"datos5\" width=\"60%\">&nbsp;");
      out.print(strDesCuadro></td>			
